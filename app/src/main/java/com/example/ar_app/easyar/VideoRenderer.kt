...
"""
    ...
    companion object {
        private fun getGLMatrix(m: Matrix44F): FloatArray {
            ...
            return floatArrayOf(
                ...
                d[5],
                d[9],
                d[13], d[2], d[6], d[10], d[14], d[3], d[7], d[11], d[15]
            )
        }
    }
    ...
    init {
        ...
        GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, vbo_tex_box)
        val cube_vertex_texs =
            arrayOf(intArrayOf(1, 0), intArrayOf(1, 1), intArrayOf(0, 1), intArrayOf(0, 0))
        val cube_vertex_texs_buffer =
            ByteBuffer.wrap(byteArrayFromIntArray(flatten(cube_vertex_texs)))
        GLES20.glBufferData(
            GLES20.GL_ARRAY_BUFFER,
            cube_vertex_texs_buffer.limit(),
            cube_vertex_texs_buffer,
